  ...
  <section class="mx-auto max-w-7xl px-4 py-6">
    ...
    <div class="mt-3 grid grid-cols-1 gap-4 md:grid-cols-2">
      <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
        <h3 class="text-center text-xs font-semibold uppercase tracking-wide text-gray-500">People We Want to Connect With</h3>
      ...
      <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
        <h3 class="text-center text-xs font-semibold uppercase tracking-wide text-gray-500">Hospitals</h3>
        <ul class="mt-2 space-y-2 text-sm">
      ...
      <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
        <h3 class="text-center text-xs font-semibold uppercase tracking-wide text-gray-500">Shelters</h3>
        <ul class="mt-2 space-y-2 text-sm">
      ...
      <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
        <h3 class="text-center text-xs font-semibold uppercase tracking-wide text-gray-500">Bus Providers</h3>
        <ul class="mt-2 space-y-2 text-sm">
